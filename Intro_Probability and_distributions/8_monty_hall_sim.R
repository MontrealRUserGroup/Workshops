## This code was copied directly from Rosetta Code
## http://rosettacode.org/wiki/Monty_Hall_problem#R
## This is a good ressource for people already well versed in another language/code
## It also contains many examples for R
